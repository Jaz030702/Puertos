...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.diccColor = {
            -1: "background-color: rgb(139, 69, 19); border-radius:60px;",
            -2: "background-color: rgb(255, 255, 0); border-radius:60px;",
            -3: "background-color: rgb(128, 0, 128); border-radius:60px;",
            -4: "background-color: rgb(255, 105, 180); border-radius:60px;",
            0: "background-color: rgb(0, 0, 0); border-radius:60px;",
            1: "background-color: rgb(255, 105, 180); border-radius:60px;",
            2: "background-color: rgb(255, 255, 0); border-radius:60px;",
            3: "background-color: rgb(128, 0, 128); border-radius:60px;",
            4: "background-color: rgb(139, 69, 19); border-radius:60px;"
        }
