...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_calcular.setGeometry(QtCore.QRect(160, 180, 191, 61))
        self.btn_calcular.setObjectName("btn_calcular")
        self.txt_altura = QtWidgets.QLineEdit(self.centralwidget)
        self.txt_altura.setGeometry(QtCore.QRect(160, 10, 191, 41))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(90, 20, 61, 31))
        ...
        self.txt_peso.setGeometry(QtCore.QRect(160, 60, 191, 41))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
